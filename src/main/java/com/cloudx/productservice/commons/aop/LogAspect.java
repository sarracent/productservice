package com.cloudx.productservice.commons.aop;

import com.cloudx.productservice.annotations.auditable.AuditableApi;
import com.cloudx.productservice.annotations.log.LogException;
import com.cloudx.productservice.annotations.log.LogIgnore;
import com.cloudx.productservice.commons.resolver.CustomHeadersResolver;
...
import com.cloudx.productservice.utility.LogUtil;
import com.cloudx.productservice.utility.Logs;
...
import static com.cloudx.productservice.utility.Logs.Basic.*;
import static com.cloudx.productservice.utility.Logs.Extras.ERROR_EXECUTE;
import static com.cloudx.productservice.utility.Logs.Extras.START_TIME;
import static com.cloudx.productservice.utility.Logs.Header.*;
...
public class LogAspect {
    ...
    @Around("@annotation(com.cloudx.productservice.annotations.auditable.AuditableApi)")
    ...
    @Around("@annotation(com.cloudx.productservice.annotations.log.LogService))")
    ...
    @Pointcut("within(com.cloudx.productservice..*)")
