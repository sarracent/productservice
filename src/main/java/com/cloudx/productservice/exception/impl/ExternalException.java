package com.cloudx.productservice.exception.impl;

import com.cloudx.productservice.exception.CustomException;
import com.cloudx.productservice.exception.ExceptionType;

import java.util.Collections;
import java.util.List;

public class ExternalException extends RuntimeException implements CustomException {
    ...
    public ExternalException(String code, String message, List<Object> extraInfo) {
        super(message);
        this.code = code;
        this.message = message;
